...
class InheritanceTests(object):
    ...
    def test_inherited_grants_for_user(self):
        ...
        roles_ref = self.assignment_api.list_inheritable_grants(
            user_id=user1['id'],
            project_id=project1['id'])
        self.assertEqual(0, len(roles_ref))
        roles_ref = self.assignment_api.list_direct_grants(
            user_id=user1['id'],
            project_id=project1['id'])
        self.assertEqual(0, len(roles_ref))
        ...
        roles_ref = self.assignment_api.list_direct_grants(
            ...
            project_id=project1['id'])
        self.assertEqual(1, len(roles_ref))
        self.assertIn(direct_project_role, roles_ref)
        ...
        roles_ref = self.assignment_api.list_direct_grants(
            ...
            project_id=subproject1['id'])
        self.assertEqual(1, len(roles_ref))
        self.assertIn(direct_subproject_role, roles_ref)
        ...
        inheritable_roles_ref = self.assignment_api.list_inheritable_grants(
            user_id=user1['id'],
            project_id=project1['id'])
        roles_ref = self.assignment_api.list_direct_grants(
            user_id=user1['id'],
            project_id=project1['id'])
        self.assertEqual(1, len(inheritable_roles_ref))
        ...
        roles_ref = self.assignment_api.list_direct_grants(
            user_id=user1['id'],
            project_id=project1['id'])
        self.assertEqual(2, len(inheritable_roles_ref))
        self.assertIn(domain_inherited_role, inheritable_roles_ref)
        self.assertIn(project_inherited_role, inheritable_roles_ref)
        self.assertEqual(2, len(roles_ref))
        self.assertIn(direct_project_role, roles_ref)
        self.assertIn(project_inherited_role, inheritable_roles_ref)
        ...
        self.assertIn(domain_inherited_role, inheritable_roles_ref)
        self.assertEqual(2, len(roles_ref))
        self.assertIn(direct_domain_role, roles_ref)
        self.assertIn(domain_inherited_role, inheritable_roles_ref)

    def test_inherited_grants_for_group(self):
        """Test inherited user roles.
        ...
        # should now include the inherited role on the domain
        inheritable_roles_ref = self.assignment_api.list_inheritable_grants(
            group_id=group1['id'], project_id=subproject1['id'])
        roles_ref = self.assignment_api.list_direct_grants(
            group_id=group1['id'],
            project_id=subproject1['id'])
        self.assertEqual(1, len(inheritable_roles_ref))
    ...
    def test_inherited_list_grants_for_user(self):
        """Test inherited user roles.
        ...
        roles_ref = self.assignment_api.list_grants(
            user_id=user1['id'],
            project_id=subproject1['id'], inherited_to_projects=None)
        self.assertEqual(0, len(inheritable_roles_ref))
        self.assertEqual(0, len(roles_ref))
    ...
    def test_inherited_list_grants_for_group(self):
        """Test inherited user roles.
    ...
    def test_grants_for_group(self):
        """Test inherited user roles.
        ...
        role_list = self._create_random_roles(5)
        domain1 = self._create_random_domain()
        group1 = self._create_random_user(domain_id=domain1['id'])
        project1 = self._create_random_project(domain_id=domain1['id'])
        subproject1 = self._create_random_project(
            domain_id=domain1['id'], parent_project_id=project1['id'])
        ...
        self.assertRaises(exception.RoleNotFound,
                          ...
                          group_id=group1['id'], project_id=project1['id'])
        self.assignment_api.get_direct_grant(
            role_id=direct_project_role['id'], group_id=group1['id'],
            project_id=project1['id'])
        ...
        self.assertRaises(exception.RoleNotFound,
                          ...
                          group_id=group1['id'], project_id=subproject1['id'])
        self.assignment_api.get_direct_grant(
            role_id=direct_subproject_role['id'], group_id=group1['id'],
            project_id=subproject1['id'])
        ...
        self.assertRaises(exception.RoleNotFound,
                          ...
                          group_id=group1['id'], domain_id=domain1['id'])
        self.assignment_api.get_direct_grant(
            role_id=direct_domain_role['id'], group_id=group1['id'],
            domain_id=domain1['id'])
        ...
        self.assignment_api.get_inheritable_grant(
            role_id=domain_inherited_role['id'], group_id=group1['id'],
            project_id=project1['id'])
        self.assertRaises(exception.RoleNotFound,
                          self.assignment_api.get_direct_grant,
                          role_id=domain_inherited_role['id'],
        ...
        self.assignment_api.get_inheritable_grant(
            role_id=project_inherited_role['id'], group_id=group1['id'],
            project_id=project1['id'])
        self.assignment_api.get_direct_grant(
            role_id=project_inherited_role['id'], group_id=group1['id'],
            project_id=project1['id'])
    ...
    def test_get_grants_for_group(self):
        """Test inherited user roles.
    ...
    def test_get_roles_grants_for_user(self):
        """Test inherited user roles.
